...
export const proposeTechnicalFinding = (workspaceId: string, body: { method_application_id: string; technical_proposition: string; scope: string; limitation: string; uncertainty: string; uncertainty_impact: string; origin: "AI_PROPOSAL" | "PROFESSIONAL_PROPOSAL"; contrary_evidence_ids: string[]; expected_revision: number }) => command(workspaceId, "finding-proposals", body);
