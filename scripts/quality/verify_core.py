...
def run_gate(mode: str, root: Path = ROOT, *, runner=subprocess.run, tracked_files: list[str] | None = None) -> GateResult:
    ...
    commands = [
        ("architecture tests", [sys.executable, "-m", "pytest", "-q", "tests/test_architecture_gate.py"], "ARCHITECTURE_DIRECTION", "QUALITY_GATE"),
