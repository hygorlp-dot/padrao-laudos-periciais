...
def run_gate(mode: str, root: Path = ROOT, *, runner=subprocess.run, tracked_files: list[str] | None = None) -> GateResult:
    ...
    if mode == "full":
        commands.extend([
            ...
            ("capability cutover tests", [sys.executable, "-m", "pytest", "-q", "tests/test_capability_analyzer_v1.py", "tests/test_capability_exceptions_v1.py", "tests/test_capability_contracts_v1.py", "tests/test_architecture_analyzer_v1.py", "tests/test_architecture_capability_trust_anchor_v1.py", "tests/test_architecture_capability_control_plane_rotation_v1.py"], "FAIL_CLOSED", "QUALITY_GATE"),
