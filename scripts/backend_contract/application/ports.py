...
class PrivateContentRepository(Protocol):
    def store(self, metadata: PrivateContentMetadata, content: bytes | SeekableContent) -> PrivateContentMetadata: ...

    def get(self, workspace_id: WorkspaceId, content_id: PrivateContentId) -> PrivateContent | None: ...

    def list_all(self, workspace_id: WorkspaceId) -> tuple[PrivateContentMetadata, ...]: ...


class PrivateContentStreamRepository(PrivateContentRepository, Protocol):
    def open_content(self, workspace_id: WorkspaceId, content_id: PrivateContentId) -> OpenPrivateContent | None: ...
