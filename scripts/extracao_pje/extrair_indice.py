    ...
    for pagina_numero in paginas_indice:
        ...
        for tabela in pagina.extract_tables() or []:
            for linha in tabela:
                ...
                destino = candidatos[0] if len(candidatos) == 1 else (
                    destinos_ordenados[ordem_na_pagina] if ordem_na_pagina < len(destinos_ordenados) else None
                )
                ordem_na_pagina += 1
                ...
                itens.append({
                    ...
                    "confianca": {"nivel": "ALTA" if destino else "MEDIA", "score": 1.0 if destino else 0.8},
                })
    return itens
