...
def _fontes_da_proveniencia(evidencia):
    fontes=set()
...
def fontes_independentes(evidencias,sinais):
    return {fonte for e in evidencias if set(e.get("aspectos_suportados",[]))&set(sinais) for fonte in _fontes_da_proveniencia(e)}
