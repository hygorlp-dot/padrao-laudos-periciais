...
def test_openapi_component_reuses_canonical_schema_and_declares_semantic_boundary():
    ...
    assert set(contract["paths"]) == {
            ...
            "/v1/workspaces/{workspace_id}/construction-defect-analysis",
        ...
        "/v1/ai-assistant/status",
        "/v1/workspaces/{workspace_id}/photo-library/photos",
        "/v1/workspaces/{workspace_id}/photo-library/descriptions",
        "/v1/workspaces/{workspace_id}/photo-library/selection",
        "/v1/workspaces/{workspace_id}/photo-library/removals",
        "/v1/workspaces/{workspace_id}/photo-library/photos/{photo_id}/thumbnail",
        "/v1/workspaces/{workspace_id}/report-snapshot/versions",
        "/v1/workspaces/{workspace_id}/site-location/confirmation",
