...
class CorrecaoCirurgicaMotorV1Test(unittest.TestCase):
    ...
    def test_nor_auth_01_02_e_blind_05(self):
        ...
        oficial={**blog,"proveniencia":["https://www.abnt.org.br/norma"],"classificacao_fonte":"FONTE_PRIMARIA_OFICIAL","entidade":"Entidade oficial sintética","documento":"Documento sintético","dominio":"abnt.org.br","url":"https://www.abnt.org.br/norma","dominio_oficial":True,"status_verificacao":"VERIFICADO"};self.assertEqual((proposicao(oficial)["authority"],proposicao(oficial)["verdict"]),("FONTE_PRIMARIA_OFICIAL","SUPPORTED"))
