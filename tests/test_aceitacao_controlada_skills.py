...
class AceitacaoControladaSkillsTest(unittest.TestCase):
    ...
    def norma(self,limite=.5):return {"id":"NOR-001","titulo":"Norma sintética","numero":"1","requisito":"Abertura máxima sintética","verificada":True,"aplicabilidade_temporal":"APLICAVEL_PRINCIPAL","vigencia_inicio":"2010-01-01","edicao":"2010","item":"1","pagina":1,"tipo_requisito":"DESEMPENHO","metodo_verificacao":"Medição direta","criterio":{"operador":"<=","valor":limite,"unidade":"mm","grandeza":"abertura"},"proveniencia":["NOR-LOCAL"],"sistema":"IMPERMEABILIZACAO","classificacao_fonte":"FONTE_TECNICA_LOCAL_VERIFICADA","entidade":"Entidade sintética","documento":"Norma sintética","dominio":None,"url":None,"dominio_oficial":False,"status_verificacao":"VERIFICADO","escopo_fonte":"CONTEUDO_NORMATIVO","conteudo_normativo_verificado":True,"conteudo_consultado":"Abertura máxima sintética"}
